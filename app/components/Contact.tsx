...
const contacts = [
  {
    label: "Email",
    value: "feitosatriz@gmail.com",
    href: "mailto:feitosatriz@gmail.com",
    icon: (
  ...
  },
  {
    label: "LinkedIn",
    value: "/in/bzfeitosa",
    href: "https://linkedin.com/in/bzfeitosa",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--accent)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    label: "GitHub",
    value: "@beatrizfeitosa",
    href: "https://github.com/beatrizfeitosa",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--accent)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
